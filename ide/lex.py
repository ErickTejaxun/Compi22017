...
states = ( 
	('COMILLAS','exclusive'),
	('COMENTARIOS','exclusive'),
	('COMENTARIOM','exclusive'),	
#	('COMILLAS','inclusive'),
)
#palabras reservadas
reserved = {
...
#Estado dos, que se da cuando encuentra comillas.

def t_begin_COMILLAS(t):
	r'"'
	print("Comenzando Estado comillas")
	t.lexer.begin('COMILLAS')

def t_COMILLAS_PATHLINUX(t):
	#r'/([a-zA-Z_][a-zA-Z_0-9]*| \t)+'
	r'(/[a-zA-Z_][a-zA-Z_0-9]*)+'
	#t.value = (t.value, symbol_lookup(t.value))
	return t
			   
def t_COMILLAS_PATHWINDOWS(t):
	r'[A-Z_]:(\\[a-zA-Z_][a-zA-Z_0-9]*)+'
        #t.value = (t.value, symbol_lookup(t.value))
	return t			   

def t_COMILLAS_TEXT(t):
	#r'[[[a-zA-Z_][a-zA-Z_0-9]*]| \t]+'
	r'[a-zA-Z_][a-zA-Z_0-9]*'

def t_COMILLAS_ARCHIVO(t):
	r'.[a-zA-Z_][a-zA-Z_0-9]*'
	return t
...
def t_COMILLAS_end(t):
	r'"'
	print("Saliendo estado comillas")
	t.lexer.begin('INITIAL')
#Fin estado COMILLAS.

#Inicio estado comentario multilinea.
def t_begin_COMENTARIOM(t):
	r'\#\*'
	print("Comentario multilinea")
	t.lexer.begin('COMENTARIOM')

t_COMENTARIOM_ignore= " \t\n"

def t_COMENTARIOM_TEXT(t):
	#r'[[a-zA-Z_][a-zA-Z_0-9]*|[0-9_][a-zA-Z_0-9]*|.|,|;|{|}|(|)]+'
	r'[a-zA-Z_][a-zA-Z_0-9]*|[0-9_][a-zA-Z_0-9]*'
	pass
def t_COMENTARIOM_end(t):
	r'\*\#'
	print('Fin comentario multilinea')
	t.lexer.begin('INITIAL')

#Fin estado comentario multilinea

#Estado de comentario simple.
def t_begin_COMENTARIOS(t):
	r'\#'
	print("Iniciando comentario simple.")
	t.lexer.begin('COMENTARIOS')

t_COMENTARIOS_ignore= " \t"

def t_COMENTARIOS_TEXT(t):
	#r'[[a-zA-Z_][a-zA-Z_0-9]*|[0-9_][a-zA-Z_0-9]*|.|,|;|{|}|(|)]+'
	r'[a-zA-Z_][a-zA-Z_0-9]*|[0-9_][a-zA-Z_0-9]*'
	pass

def t_COMENTARIOS_end(t):
	r'\#'
	print("Fin comentario simple.")
	t.lexer.begin('INITIAL')
#fin estado de competario simple.
...
*#
"/home/erick"
"erick roberto tejaxun"
"/home/erick/archivo.zip"
"C:\\User\\erick\\documento.zip"
CREAR TABLA
'''
